...
#define HOMING_BUMP_MM      { 5, 5, 2, 2, 2, 2 }       // PGR (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4, 4, 4, 4 }       // PGR Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define AXIS_RELATIVE_MODES { false, false, false, false, false, false } //PGR
